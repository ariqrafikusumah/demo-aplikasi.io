...
import Logo from '../assets/img/WINX.jpg'
    ...
    <>
      <footer className="p-4 sm:p-6 bg-white xl:px-52 lg:px-32 md:px-5 mt-5">
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center">© {currentYear} <a href="#" className="text-gray-500 no-underline hover:underline">Demo</a>. All Rights Reserved.
          </span>
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://www.instagram.com/Demo/" className="text-gray-500 hover:text-gray-900" target="_blank" rel="noopener noreferrer">
            ...
            <a href="https://twitter.com/Demo" className="text-gray-500 hover:text-gray-900" target="_blank" rel="noopener noreferrer">
